...
LAST_CHECKED_TRANS = 191527939

NUM_THREAD = 100

logger.add("log_sales.log", rotation="50 MB")
...
def check_transaction_by_operation(operation_hash, mode='sales'): 
    entrypoint = 'fulfill_ask' if mode == 'sales' else 'fulfill_offer'
...
if __name__ == '__main__':
    ...
    distances = gen_distance(start=FIRST_DOG_TRANS, stop=LAST_CHECKED_TRANS, step=NUM_THREAD)
